...
namespace Chrome.DevTools.Models
{
    ...
    public partial class EventDownloadWillBeginParams
    {
        /// <summary> Initializes a new instance of EventDownloadWillBeginParams. </summary>
        ...
        public EventDownloadWillBeginParams(string frameId, string guid, string url, string suggestedFilename)
        {
