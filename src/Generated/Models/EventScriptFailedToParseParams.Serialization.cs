...
{
    [JsonConverter(typeof(EventScriptFailedToParseParamsConverter))]
    public partial class EventScriptFailedToParseParams : IUtf8JsonSerializable
    {
        ...
        internal static EventScriptFailedToParseParams DeserializeEventScriptFailedToParseParams(JsonElement element)
        {
            ...
            return new EventScriptFailedToParseParams(scriptId, url, startLine, startColumn, endLine, endColumn, executionContextId, hash, executionContextAuxData.Value, sourceMapURL.Value, Optional.ToNullable(hasSourceURL), Optional.ToNullable(isModule), Optional.ToNullable(length), stackTrace.Value, Optional.ToNullable(codeOffset), scriptLanguage.Value, embedderName.Value);
        }

        internal partial class EventScriptFailedToParseParamsConverter : JsonConverter<EventScriptFailedToParseParams>
        {
            public override void Write(Utf8JsonWriter writer, EventScriptFailedToParseParams model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override EventScriptFailedToParseParams Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeEventScriptFailedToParseParams(document.RootElement);
            }
        }
    }
}
