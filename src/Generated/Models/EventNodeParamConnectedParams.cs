...
namespace Chrome.DevTools.Models
{
    ...
    public partial class EventNodeParamConnectedParams
    {
        /// <summary> Initializes a new instance of EventNodeParamConnectedParams. </summary>
        ...
        public EventNodeParamConnectedParams(string contextId, string sourceId, string destinationId)
        {
        ...
        internal EventNodeParamConnectedParams(string contextId, string sourceId, string destinationId, float? sourceOutputIndex)
        {
            ContextId = contextId;
            SourceId = sourceId;
            DestinationId = destinationId;
