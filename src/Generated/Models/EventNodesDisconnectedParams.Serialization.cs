...
{
    [JsonConverter(typeof(EventNodesDisconnectedParamsConverter))]
    public partial class EventNodesDisconnectedParams : IUtf8JsonSerializable
    {
        ...
        internal static EventNodesDisconnectedParams DeserializeEventNodesDisconnectedParams(JsonElement element)
        {
            ...
            return new EventNodesDisconnectedParams(contextId, sourceId, destinationId, Optional.ToNullable(sourceOutputIndex), Optional.ToNullable(destinationInputIndex));
        }

        internal partial class EventNodesDisconnectedParamsConverter : JsonConverter<EventNodesDisconnectedParams>
        {
            public override void Write(Utf8JsonWriter writer, EventNodesDisconnectedParams model, JsonSerializerOptions options)
            {
                writer.WriteObjectValue(model);
            }
            public override EventNodesDisconnectedParams Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
            {
                using var document = JsonDocument.ParseValue(ref reader);
                return DeserializeEventNodesDisconnectedParams(document.RootElement);
            }
        }
    }
}
